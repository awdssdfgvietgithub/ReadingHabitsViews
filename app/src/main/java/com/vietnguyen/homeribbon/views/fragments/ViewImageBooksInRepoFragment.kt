...
class ViewImageBooksInRepoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_view_image_books_in_repo, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        booksData = viewModel.imageBooksData.value ?: listOf()
